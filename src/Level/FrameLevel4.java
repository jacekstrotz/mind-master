...
public class FrameLevel4 extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        outputArea.append("\tCorrect Numbers: " + g.getCorrect(0) +
                "\n\tCorrect Numbers with Incorrect Placement: " + g.getCorrect(1) +"\n");
        outputArea.append("Time elapsed: " + String.format("%.2f", ((stop-start)/1000.0)) + "s\n");
        
        if (g.getCorrect(0) == 4) 
            DataModel.ms.addScore(new Score(nameTextField.getText(), LocalDateTime.now(), iterator, ((stop-start)/1000.0)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameLevel4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameLevel4().setVisible(true);
            }
        });
    }
    ...
    private void setCode() {
        ...
        solutionTextField.setText("[ " + pegs[0] + " " + pegs[1] +
            " " + pegs[2] + " " + pegs[3] + " ]");
        start = Utility.getSystemTime();
        
        outputArea.setText("A new code has been created.\n"
                + (nameTextField.getText().isBlank() ? "Enter a name, and then try to guess the code.\n" : "Try to guess the code.\n"));
    }
